...
/*   Updated: 2023/11/05 16:56:09 by rmidou           ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
{
	if ((size_t)minimum_adresse(stack_b) < (ft_strlen(stack_b) / 2))
	{
...
static void	set_at_place_other(int *stack_a, int *stack_b)
{
	...
	if ((size_t)mini_adresse(stack_b, stack_a[0]) > (ft_strlen(stack_b) / 2) - 2)
	{
		while (stack_b[0] != i)
			rrb(stack_b, ft_strlen(stack_b));
	}
...
void	set_at_placeb(int *stack_a, int *stack_b)
{
	...
	else
	{
		...
		while (stack_b[j] > stack_a[0] && stack_b[j])
			j++;
		if ((size_t)i == (ft_strlen(stack_b)))
			set_at_placeb_maxi(stack_b);
		else if ((size_t)j == (ft_strlen(stack_b)))
